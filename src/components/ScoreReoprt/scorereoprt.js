...
var data = {
    labels: ["10/01/17", "10/16/17", "11/01/17", "11/16/17", "12/01/17", "12/16/17", "01/01/18"],
    datasets: [
        {
            backgroundColor: "rgba(0,0,0,0)",
            borderColor: '#5d90e3',
            data: [15, 17, 15, 20, 26, 28, 25]
        },
        {
            backgroundColor: "rgba(0,0,0,0)",
            borderColor: '#b9cff3',
            data: [15, 18, 17, 26, 20, 31, 33]
        }
    ]
}
...
var options = {
    title: {
        display: true,
        text: 'Composite Score Over Time',
        fontSize: 21,
...
const ScoreReoprt = () => (
    <div className="col-xs-12 col-sm-12 col-md-12">
        <div className="row" style={titleBlockStyle}>
            <div className="col-xs-12 col-sm-12 col-md-12">
                <span style={titleStyle}>Score Report: California</span>
                <Export />
            </div>
        </div>
            ...
            <div className="col-xs-12 col-sm-12 col-md-6">
                <div className="col-xs-12 col-sm-12 col-md-6">
                    <div style={countBlockStyle}>
                        <div style={countTitleStyle}>Class Count</div>
                        <div style={countNumberStyle}>305</div>
                        <div style={countNuitStyle}>Classes</div>
                    </div>
                </div>
                <div className="col-xs-12 col-sm-12 col-md-6">
                    <div style={countBlockStyle}>
                        <div style={countTitleStyle}>Student Count</div>
                        <div style={countNumberStyle}>4,103</div>
                        <div style={countNuitStyle}>Students</div>
                    </div>
                </div>
            </div>
        </div>
